      ...
      <div className="relative grid grid-cols-1 md:grid-cols-2 gap-20">
              ...
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <img
                    ...
                    draggable={false}
                    className="h-full w-full rounded-3xl object-cover object-center shadow-[0_0_30px_rgba(0,0,0,0.5)] border border-white/10"
                  />
                </motion.div>
              ))}
            </AnimatePresence>
        ...
        <div className="flex justify-between flex-col py-4">
          ...
          >
            ...
            <p className="text-sm text-brand-red font-display font-bold uppercase tracking-widest mb-6">
              {testimonials[active].designation}
            </p>
            <motion.p className="text-lg text-gray-400 font-sans leading-relaxed">
